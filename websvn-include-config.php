...
// Hook to use SMF authentication
require_once('/home/arcdev/public_html/forum/SSI.php');
...
//$config->addRepository("Chases Test Repo", 'file:///home/arcdev/svn/test');
//$config->addRepository("Same Repo, Subgrouped", 'file:///home/arcdev/svn/test', 'testgroup');
//$config->addRepository('SMF-SVN_Interface', 'file:///home/arcdev/svn/SMF-SVN_Interface');

// 110215 Chase McManning - Switched to external ini file for repo listings
$repos = parse_ini_file($modSettings['svnRoot'] . 'repos.ini');

foreach ($repos as $repo => $title)
{
	$config->addRepository($title, 'file://' . $modSettings['svnRoot'] . $repo);
}
...
//$config->useAuthenticationFile('/home/arcdev/svn/sspi_auth'); // Global access file
